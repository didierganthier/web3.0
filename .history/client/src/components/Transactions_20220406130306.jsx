...
function TransactionCard({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) {
    ...
    <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
      <div className='flex flex-col md:p-12 py-12 px-4'>
        {connectedAccount? (
          ...
          <h3 className='text-white text-3xl text-center my-2'>Connect your account to see the laatest transactions</h3>
        )}
      </div>
